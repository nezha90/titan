...
const (
	Query_Params_FullMethodName   = "/titan.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/titan.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/titan.tokenfactory.Query/DenomAll"
)
