...
func init() {
	...
	md_Denom = File_titan_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_titan_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "titan.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "titan.tokenfactory.Denom.description":
		return x.Description != ""
	case "titan.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "titan.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "titan.tokenfactory.Denom.url":
		return x.Url != ""
	case "titan.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != uint64(0)
	case "titan.tokenfactory.Denom.supply":
		return x.Supply != uint64(0)
	case "titan.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "titan.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: titan.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message titan.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message titan.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "titan.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message titan.tokenfactory.Denom is not mutable"))
	case "titan.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message titan.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: titan.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in titan.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: titan/tokenfactory/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_titan_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
func (x *Denom) GetMaxSupply() uint64 {
	if x != nil {
		return x.MaxSupply
	}
	return 0
...
var File_titan_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_titan_tokenfactory_denom_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x09, 0x6d, 0x61, 0x78, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x12, 0x16, 0x0a, 0x06,
	0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x75,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x42, 0xb2, 0x01, 0x0a, 0x16, 0x63,
	...
	,
}

var (
	file_titan_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_titan_tokenfactory_denom_proto_rawDescData = file_titan_tokenfactory_denom_proto_rawDesc
)

func file_titan_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_titan_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_titan_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_titan_tokenfactory_denom_proto_rawDescData)
	})
	return file_titan_tokenfactory_denom_proto_rawDescData
}

var file_titan_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_titan_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: titan.tokenfactory.Denom
}
var file_titan_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_titan_tokenfactory_denom_proto_init() }
func file_titan_tokenfactory_denom_proto_init() {
	if File_titan_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_titan_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_titan_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_titan_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_titan_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_titan_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_titan_tokenfactory_denom_proto = out.File
	file_titan_tokenfactory_denom_proto_rawDesc = nil
	file_titan_tokenfactory_denom_proto_goTypes = nil
	file_titan_tokenfactory_denom_proto_depIdxs = nil
}
