...
/**
 * @title HTTP API Console titan.tokenfactory
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryDenomAll
   * @request GET:/titan/tokenfactory/denom
   */
  queryDenomAll = (
    query?: {
   ...
   * @tags Query
   * @name QueryDenom
   * @request GET:/titan/tokenfactory/denom/{denom}
   */
  queryDenom = (denom: string, params: RequestParams = {}) =>
    this.request<
      ...
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/titan/tokenfactory/denom/${denom}`,
      method: "GET",
      ...params,
    });
